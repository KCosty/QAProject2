...
namespace Project
{
    public static class WebElements
    {
        ...
        {
            IWebElement txtUserName = driver.FindElement(By.Id("usr"));
            return txtUserName;
        }
        public static IWebElement txtPassword(IWebDriver driver)
        {
            IWebElement txtPassword = driver.FindElement(By.Id("pword"));
            return txtPassword;
        }*/

        public static IWebElement ddlSubject(IWebDriver driver)
        {
            IWebElement ddlSubject = driver.FindElement(By.Id("id_contact"));
            return ddlSubject;
        }
        ...
        public static IWebElement txtOrderRef(IWebDriver driver)
        {
            IWebElement txtOrderRef = driver.FindElement(By.Id("id_order"));
            return txtOrderRef;
        }
